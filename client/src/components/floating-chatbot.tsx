      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            <Button
              onClick={toggleChat}
              /* Icon-only, so it carries no text node and a screen reader
                 announced "button" and nothing more. The unread count goes in
                 the name too — a badge is a visual signal only. */
              aria-label={
                unreadCount > 0
